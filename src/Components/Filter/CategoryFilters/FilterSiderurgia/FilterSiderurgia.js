...
//Importando icones
import icon from "../../../../assets/img/metalurgica.png"

function FilterSiderurgia() {
                ...
                <div className='container_category_page_detail'>
                    <div className='container_category_page'>
                        ...
                        <img className="icon_category" src={icon} />
                            <h1 className="ui header motor search">Siderurgia</h1>
                            <br />
    ...
    const renderMobileView = () => (
        <>
            <div className="category_second_filter_mobile">
                <h2 className="search_mobile">Siderurgia</h2>
                <br />
...
export default FilterSiderurgia;